...
import { TrendingUp, Zap, Database, Users, Rocket, Shield } from "lucide-react";

import { Card, CardContent } from "@/components/ui/card";

function RealTimeInsightsChart() {
  const width = 366;
  const height = 231;
  const topPadding = 16;
  ...
  const [series, setSeries] = React.useState(() =>
    Array.from({ length: 80 }, (_, i) => {
      const base = 112 - i * 0.35;
      return Math.max(20, Math.min(210, base + (Math.random() - 0.5) * 40)); // Increased range for higher peaks
    }),
  );
  ...
  React.useEffect(() => {
    const intervalId = window.setInterval(() => {
      setSeries((prev) => {
        ...
        const drift = (Math.random() - 0.5) * 30; // Increased drift for higher peaks
        const nextPoint = Math.max(
          topPadding + 8,
          Math.min(height - bottomPadding, lastPoint + drift),
        );
  ...
  const { linePath, areaPath, lastX, lastY } = React.useMemo(() => {
    ...
    const linePoints = series
      .map((y, index) => `${index * stepX},${y}`)
      .join(" ");
    const firstY = series[0] ?? height - bottomPadding;
    const lastIndex = Math.max(series.length - 1, 0);
    const currentLastX = lastIndex * stepX;
    const currentLastY = series[lastIndex] ?? firstY;

    return {
      linePath: `M ${linePoints}`,
      areaPath: `M 0,${height - bottomPadding} L 0,${firstY} L ${linePoints} L ${currentLastX},${height - bottomPadding} Z`,
      lastX: currentLastX,
      lastY: currentLastY,
    };
  }, [series]);
  ...
  return (
    <svg
      ...
      aria-label="Live performance chart"
      role="img"
    >
      <defs>
        <linearGradient id="insightsAreaFill" x1="0" y1="0" x2="0" y2={height}>
      ...
      <path
        ...
        className="text-emerald-500/25 dark:text-emerald-400/30"
      />
      <path
        d={linePath}
        fill="none"
  ...
  const benefits = [
    {
      ...
      description:
        "Streamline your workflows and reduce time spent on repetitive tasks",
    },
    {
      icon: Zap,
      title: "Reduce manual work and costly mistakes",
      description:
        "Automate critical processes and eliminate human error from your operations",
    },
    {
      icon: Database,
      title: "Centralize data across your business",
      description:
        "Keep all your business information in one secure, accessible location",
    },
    {
      icon: Users,
      title: "Enhance team collaboration",
      description:
        "Enable teams to work together seamlessly across departments",
    },
    {
      icon: Rocket,
      title: "Scale your processes as your company grows",
      description:
        "Grow without limitations with a platform built for scalability",
    },
  ];

  return (
    <section className="relative py-10 overflow-hidden" id="why-animux">
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-10 md:mb-10">
          ...
          <p className="text-lg text-zinc-600 dark:text-white">
            Transform your business operations with powerful features designed
            for modern companies
          </p>
        </div>

        <section className="py-10 dark:bg-transparent">
          <div className="mx-auto px-6">
            <div className="relative">
              <div className="relative z-10 grid grid-cols-6 gap-3">
                <Card className="relative col-span-full flex overflow-hidden dark:bg-black dark:text-white lg:col-span-2">
                  <CardContent className="relative m-auto size-fit pt-6">
                    <div className="relative flex h-24 w-56 items-center">
                      <svg
                        className="absolute inset-0 size-full text-emerald-600 dark:text-emerald-500"
                        viewBox="0 0 254 104"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                      >
                    ...
                    <h2 className="mt-6 text-center text-3xl font-semibold text-zinc-900 dark:text-white">
                      Customizable
                    </h2>
                  </CardContent>
                </Card>
                <Card className="relative col-span-full overflow-hidden dark:bg-black dark:text-white sm:col-span-3 lg:col-span-2">
                  <CardContent className="pt-6">
                    ...
                    <div className="relative z-10 mt-14 space-y-2 text-center">
                      <h2 className="text-lg font-medium text-zinc-900 transition dark:text-white">
                        Secure by default
                      </h2>
                      <p className="text-zinc-600 dark:text-white">
                        Protect sensitive business data with reliable access
                        control and built-in security.
                      </p>
                    </div>
                  </CardContent>
                </Card>
                <Card className="relative col-span-full overflow-hidden dark:bg-black dark:text-white sm:col-span-3 lg:col-span-2">
                  <CardContent className="pt-6">
                    <div className="pt-6 lg:px-6">
                      <svg
                        className="w-full dark:text-emerald-600"
                        viewBox="0 0 386 123"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        ...
                        <path
                          className="text-emerald-600 dark:text-emerald-500"
                          d="M3 121.077C3 121.077 15.3041 93.6691 36.0195 87.756C56.7349 81.8429 66.6632 80.9723 66.6632 80.9723C66.6632 80.9723 80.0327 80.9723 91.4656 80.9723C102.898 80.9723 100.415 64.2824 108.556 64.2824C116.696 64.2824 117.693 91.9728 124.78 91.9728C132.343 91.9728 142.264 78.03 153.831 80.5508C165.398 83.0716 186.825 91.9728 193 91.9728C199.908 91.9728 205.274 63.5348 213.017 63.5348C220.76 63.5348 237.832 93.8946 243.39 91.9728C248.948 90.3718 257.923 60.5 265.284 60.5C271.145 60.5 283.204 87.7182 285.772 87.756C293.823 87.8746 299.2 73.0802 304.411 73.0802C311.283 73.0802 321.425 65.9506 333.552 64.2824C345.68 62.6141 346.91 82.4553 362.27 80.9723C377.629 79.4892 383 106.605 383 106.605"
                          stroke="currentColor"
                          strokeWidth="3"
                        />
                        <defs>
                          ...
                          >
                            <stop
                              className="text-emerald-600/15 dark:text-emerald-400/35"
                              stopColor="currentColor"
                            />
                            <stop
                              className="text-emerald-600/0 dark:text-emerald-400/0"
                              offset="1"
                              stopColor="currentColor"
                    ...
                    <div className="relative z-10 mt-14 space-y-2 text-center">
                      ...
                      <p className="text-zinc-600 dark:text-white">
                        Work without delays using a responsive ERP built for
                        everyday business operations.
                      </p>
                    </div>
                  </CardContent>
                </Card>
                <Card className="relative col-span-full overflow-hidden dark:bg-black dark:text-white lg:col-span-3">
                  <CardContent className="grid pt-6 sm:grid-cols-2">
                    <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                      <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/20 dark:before:border-white/5">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-zinc-600 dark:text-white">
                          Track performance, monitor trends, and make smarter
                          decisions with live business data.
                        </p>
                      </div>
                    </div>
                    <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-emerald-800 p-6 py-6 sm:ml-6">
                      <div className="absolute left-3 top-2 flex gap-1">
                        <span className="block size-2 rounded-full border border-emerald-800/50 bg-emerald-500/20"></span>
                        <span className="block size-2 rounded-full border border-emerald-800/50 bg-emerald-500/20"></span>
                        <span className="block size-2 rounded-full border border-emerald-800/50 bg-emerald-500/20"></span>
                      </div>
                      <div className="mt-3 w-full sm:w-[150%]">
                        <RealTimeInsightsChart />
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                    <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-zinc-600 dark:text-white">
                          Keep departments aligned with one shared platform for
                          communication, tasks, and operations.
                        </p>
                      </div>
                    </div>
                    <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                      <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                          ...
                          <div className="size-7 ring-2 ring-emerald-500/70 ring-offset-2 ring-offset-black">
                            <img
                        ...
                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                          <div className="size-8 ring-2 ring-emerald-500/70 ring-offset-2 ring-offset-black">
                            <img
                              className="size-full rounded-full"
